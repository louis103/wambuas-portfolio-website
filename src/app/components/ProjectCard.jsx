    ...
    <div>
      ...
      >
        ...
        {gitUrl ? (
            ...
            <div className="h-14 w-14 mr-2 border-2 relative rounded-full border-[#ADB7BE] opacity-50 cursor-not-allowed">
          ...
          {previewUrl ? (
            ...
            <div className="h-14 w-14 border-2 relative rounded-full border-[#ADB7BE] opacity-50 cursor-not-allowed">
